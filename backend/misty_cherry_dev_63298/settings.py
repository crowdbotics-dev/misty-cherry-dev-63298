"""
Django settings for misty_cherry_dev_63298 project.
...
ROOT_URLCONF = 'misty_cherry_dev_63298.urls'
...
WSGI_APPLICATION = 'misty_cherry_dev_63298.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_cherry_dev_63298 API",
    "DESCRIPTION": "API documentation for misty_cherry_dev_63298 App",
    "VERSION": "v1",
}
